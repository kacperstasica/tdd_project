...
class NewListViewUnitTest(unittest.TestCase):
    ...
    def test_passes_POST_data_to_NewListForm(self, mock_new_list_form):
        # https://stackoverflow.com/a/50973892
        # Django 2< does not support bytestrings in redirect views so
        # due to "TypeError: quote_from_bytes() expected bytes" exception
        # the solution is to mock get_absolute_url return value
        mock_form = mock_new_list_form.return_value
        returned_object = mock_form.save.return_value
        returned_object.get_absolute_url.return_value = 'fake_url'
